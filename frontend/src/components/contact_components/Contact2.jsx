...
const Contact2 = () => {
  ...
  return (
    <div>
      <section className="py-24" style = {{backgroundColor:contactData.bgColor, color:contactData.textColor}}>
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 grid-cols-1 gap-x-24">
            <div className="flex items-center lg:mb-0 mb-10"   style={{ color: contactData.textColor }}>
              <div className=''>
                <h4 className="text-base font-medium leading-6 mb-4 lg:text-left text-center">{contactData.title}</h4>
            ...
            <div className="lg:max-w-xl w-full h-[600px] flex items-center justify-center bg-cover bg-no-repeat" style={{ backgroundImage: `url(${contactData.imageUrl})` }}>
              <div className="lg:w-96 w-auto h-auto bg-white  text-black shadow-xl lg:p-6 p-4">
                <a href="javascript:;" className="flex items-center mb-6">
                  ...
                  <h5 className="text-base font-normal leading-6 ml-5">{contactData.phone}</h5>
                </a>
                <a href="javascript:;" className="flex items-center mb-6">
                  <svg width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <h5 className="ext-base font-normal leading-6 ml-5">{contactData.email}</h5>
                </a>
                <a href="javascript:;" className="flex items-center mb-6">
                  <svg width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
