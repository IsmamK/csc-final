...
<section className="bg-white ">
    <div className="p-20 mx-auto max-w-screen-xl  grid lg:grid-cols-2 gap-8 lg:gap-16 ">
        <div className="flex flex-col justify-center">
            <h1 className="mb-4 text-5xl lg:text-7xl font-extrabold tracking-tight leading-none  md:text-5xl lg:text-6xl dark:text-white ">Discover Our Vision </h1>
            ...
            <div className="flex flex-col space-y-4 sm:flex-row sm:space-y-0">
                <a href="#" className="inline-flex justify-center items-center py-3 px-5 bg-csc  font-medium text-center text-white rounded-lg focus:ring-4 focus:ring-blue-300 dark:focus:ring-blue-900">
                    Get started
